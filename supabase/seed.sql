...
-- Ice Knife — 4 frames, 1050ms, sound: ice_knife.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Ice Knife', null, 1050, '[{"t_ms":0,"hex":"#A8D4EC","brightness":0.5,"fade_ms":140},{"t_ms":140,"hex":"#5BB8E8","brightness":0.95,"fade_ms":80},{"t_ms":220,"hex":"#90C8E8","brightness":0.45,"fade_ms":280},{"t_ms":500,"hex":"#80B0D0","brightness":0.16,"fade_ms":550}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Ice Knife');
-- Shield — 4 frames, 1930ms, sound: shield.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Shield', null, 1930, '[{"t_ms":0,"hex":"#FFE680","brightness":0.6,"fade_ms":500},{"t_ms":500,"hex":"#FFE680","brightness":0.92,"fade_ms":80},{"t_ms":580,"hex":"#FFF1B0","brightness":0.65,"fade_ms":350},{"t_ms":930,"hex":"#E8B040","brightness":0.22,"fade_ms":1000}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Shield');
-- Lightning Bolt — 5 frames, 1820ms, sound: lightning_bolt.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Lightning Bolt', null, 1820, '[{"t_ms":0,"hex":"#DCE8FF","brightness":0.38,"fade_ms":320},{"t_ms":320,"hex":"#EEF4FF","brightness":0.7,"fade_ms":220},{"t_ms":540,"hex":"#FFF8C8","brightness":1.0,"fade_ms":80},{"t_ms":620,"hex":"#DCE8FF","brightness":0.45,"fade_ms":300},{"t_ms":920,"hex":"#C8D8F0","brightness":0.12,"fade_ms":900}]'::jsonb, 2000
where not exists (select 1 from public.effects where name = 'Lightning Bolt');
-- Cure Wounds — 8 frames, 3380ms, sound: cure_wounds.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Cure Wounds', null, 3380, '[{"t_ms":0,"hex":"#FFF0D0","brightness":0.2,"fade_ms":300},{"t_ms":300,"hex":"#FFE9A8","brightness":0.4,"fade_ms":300},{"t_ms":600,"hex":"#FFE08A","brightness":0.65,"fade_ms":280},{"t_ms":880,"hex":"#FFE08A","brightness":0.9,"fade_ms":100},{"t_ms":980,"hex":"#FFD46A","brightness":0.72,"fade_ms":300},{"t_ms":1280,"hex":"#FFE9A8","brightness":0.5,"fade_ms":400},{"t_ms":1680,"hex":"#FFF1C8","brightness":0.28,"fade_ms":700},{"t_ms":2380,"hex":"#F0D098","brightness":0.12,"fade_ms":1000}]'::jsonb, 4000
where not exists (select 1 from public.effects where name = 'Cure Wounds');
-- Firebolt — 4 frames, 1420ms, sound: firebolt.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Firebolt', null, 1420, '[{"t_ms":0,"hex":"#C06018","brightness":0.52,"fade_ms":340},{"t_ms":340,"hex":"#FF7A00","brightness":0.95,"fade_ms":80},{"t_ms":420,"hex":"#D05800","brightness":0.48,"fade_ms":300},{"t_ms":720,"hex":"#5A1A00","brightness":0.1,"fade_ms":700}]'::jsonb, 2000
where not exists (select 1 from public.effects where name = 'Firebolt');
-- Prestidigitation — 6 frames, 2510ms, sound: prestidigitation.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Prestidigitation', null, 2510, '[{"t_ms":0,"hex":"#F0E0F0","brightness":0.18,"fade_ms":420},{"t_ms":420,"hex":"#E0CCEC","brightness":0.3,"fade_ms":300},{"t_ms":720,"hex":"#D8C0E8","brightness":0.42,"fade_ms":240},{"t_ms":960,"hex":"#DCC8E5","brightness":0.32,"fade_ms":300},{"t_ms":1260,"hex":"#C8B0D0","brightness":0.18,"fade_ms":450},{"t_ms":1710,"hex":"#A89AB8","brightness":0.08,"fade_ms":800}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Prestidigitation');
-- Water Whip — 6 frames, 2170ms, sound: water_whip.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Water Whip', null, 2170, '[{"t_ms":0,"hex":"#6CC8E0","brightness":0.3,"fade_ms":300},{"t_ms":300,"hex":"#48BAD8","brightness":0.55,"fade_ms":300},{"t_ms":600,"hex":"#38B8DC","brightness":0.75,"fade_ms":340},{"t_ms":940,"hex":"#48CAE4","brightness":0.95,"fade_ms":80},{"t_ms":1020,"hex":"#0096C7","brightness":0.45,"fade_ms":400},{"t_ms":1420,"hex":"#023E8A","brightness":0.16,"fade_ms":750}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Water Whip');
-- Magic Missile — 7 frames, 3040ms, sound: magic_missile.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
...
-- Blight — 5 frames, 3090ms, sound: blight.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Blight', null, 3090, '[{"t_ms":0,"hex":"#7A6010","brightness":0.4,"fade_ms":60},{"t_ms":60,"hex":"#A88018","brightness":0.58,"fade_ms":80},{"t_ms":140,"hex":"#5A3800","brightness":0.32,"fade_ms":450},{"t_ms":590,"hex":"#2A1800","brightness":0.14,"fade_ms":900},{"t_ms":1490,"hex":"#1A0F00","brightness":0.05,"fade_ms":1600}]'::jsonb, 4000
where not exists (select 1 from public.effects where name = 'Blight');
-- Mass Healing Word — 9 frames, 5840ms, sound: mass_healing_word.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Mass Healing Word', null, 5840, '[{"t_ms":0,"hex":"#FFF1C8","brightness":0.22,"fade_ms":400},{"t_ms":400,"hex":"#FFE9A8","brightness":0.42,"fade_ms":300},{"t_ms":700,"hex":"#FFD46A","brightness":0.62,"fade_ms":340},{"t_ms":1040,"hex":"#FFC640","brightness":0.78,"fade_ms":300},{"t_ms":1340,"hex":"#FFE680","brightness":0.95,"fade_ms":100},{"t_ms":1440,"hex":"#FFD46A","brightness":0.78,"fade_ms":300},{"t_ms":1740,"hex":"#FFE9A8","brightness":0.55,"fade_ms":600},{"t_ms":2340,"hex":"#FFF1C8","brightness":0.35,"fade_ms":1000},{"t_ms":3340,"hex":"#FFE8A8","brightness":0.15,"fade_ms":2500}]'::jsonb, 4000
where not exists (select 1 from public.effects where name = 'Mass Healing Word');
-- Arcane Shot — 6 frames, 2360ms, sound: arcane_shot.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
...
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Crystal Breath', null, 2200, '[{"t_ms":0,"hex":"#88CCEE","brightness":0.52,"fade_ms":400},{"t_ms":400,"hex":"#EEFFFF","brightness":0.98,"fade_ms":80},{"t_ms":480,"hex":"#66B8E8","brightness":0.52,"fade_ms":320},{"t_ms":800,"hex":"#2266AA","brightness":0.2,"fade_ms":500},{"t_ms":1300,"hex":"#224466","brightness":0.06,"fade_ms":900}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Crystal Breath');
-- Dragon Bite — 4 frames, 1050ms, sound: dragon_bite.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Dragon Bite', null, 1050, '[{"t_ms":0,"hex":"#2A0808","brightness":0.2,"fade_ms":40},{"t_ms":40,"hex":"#CC3300","brightness":0.88,"fade_ms":60},{"t_ms":100,"hex":"#550000","brightness":0.28,"fade_ms":300},{"t_ms":400,"hex":"#1A0000","brightness":0.06,"fade_ms":650}]'::jsonb, 2000
...
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Ignite', null, 990, '[{"t_ms":0,"hex":"#FF6600","brightness":0.55,"fade_ms":40},{"t_ms":40,"hex":"#FFAA00","brightness":0.92,"fade_ms":80},{"t_ms":120,"hex":"#CC4400","brightness":0.35,"fade_ms":320},{"t_ms":440,"hex":"#5A1000","brightness":0.06,"fade_ms":550}]'::jsonb, 2000
...
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Flask Shatter', null, 1550, '[{"t_ms":0,"hex":"#88AA20","brightness":0.48,"fade_ms":40},{"t_ms":40,"hex":"#CCFF66","brightness":0.92,"fade_ms":80},{"t_ms":120,"hex":"#88DD00","brightness":0.45,"fade_ms":280},{"t_ms":400,"hex":"#446600","brightness":0.2,"fade_ms":500},{"t_ms":900,"hex":"#223300","brightness":0.06,"fade_ms":650}]'::jsonb, 2000
where not exists (select 1 from public.effects where name = 'Flask Shatter');
-- Steam Blast — 5 frames, 2070ms, sound: steam_blast.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Steam Blast', null, 2070, '[{"t_ms":0,"hex":"#D8D8D8","brightness":0.52,"fade_ms":240},{"t_ms":240,"hex":"#FFFFFF","brightness":0.95,"fade_ms":80},{"t_ms":320,"hex":"#F0F0F0","brightness":0.6,"fade_ms":300},{"t_ms":620,"hex":"#C8C8C8","brightness":0.26,"fade_ms":550},{"t_ms":1170,"hex":"#A0A0A0","brightness":0.08,"fade_ms":900}]'::jsonb, 2000
where not exists (select 1 from public.effects where name = 'Steam Blast');
-- Arcane Surge — 10 frames, 6560ms, sound: arcane_surge.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Arcane Surge', null, 6560, '[{"t_ms":0,"hex":"#4A4A50","brightness":0.18,"fade_ms":800},{"t_ms":800,"hex":"#8A8A8A","brightness":0.35,"fade_ms":1000},{"t_ms":1800,"hex":"#C0C0C0","brightness":0.55,"fade_ms":1000},{"t_ms":2800,"hex":"#E8D080","brightness":0.7,"fade_ms":900},{"t_ms":3700,"hex":"#F8E090","brightness":0.85,"fade_ms":560},{"t_ms":4260,"hex":"#FFFFFF","brightness":0.98,"fade_ms":100},{"t_ms":4360,"hex":"#E8D080","brightness":0.75,"fade_ms":200},{"t_ms":4560,"hex":"#A09050","brightness":0.5,"fade_ms":300},{"t_ms":4860,"hex":"#705030","brightness":0.22,"fade_ms":500},{"t_ms":5360,"hex":"#3A2810","brightness":0.08,"fade_ms":1200}]'::jsonb, 3000
where not exists (select 1 from public.effects where name = 'Arcane Surge');
-- Sand Blast — 5 frames, 1420ms, sound: sand_blast.wav
insert into public.effects (name, sound_path, duration_ms, frames, revert_ms)
select 'Sand Blast', null, 1420, '[{"t_ms":0,"hex":"#886020","brightness":0.32,"fade_ms":220},{"t_ms":220,"hex":"#C08840","brightness":0.65,"fade_ms":200},{"t_ms":420,"hex":"#FFD080","brightness":0.92,"fade_ms":80},{"t_ms":500,"hex":"#A07030","brightness":0.38,"fade_ms":320},{"t_ms":820,"hex":"#704A1A","brightness":0.1,"fade_ms":600}]'::jsonb, 2000
